...
public:
	 ...
	 */
	[[nodiscard]]
	static constexpr uint8_t Adjust(uint8_t inChannel, uint8_t inFactor)
	{
	 ...
	 */
	[[nodiscard]]
	static constexpr uint32_t AdjustColorWithBleed(uint32_t inColor, uint8_t inBleed)
	{
	 ...
	 */
	[[nodiscard]]
	static constexpr uint8_t Blend(uint8_t inChannel, uint8_t inFactor)
	{
	 ...
	 */
	[[nodiscard]]
    static constexpr uint32_t BlendColorChannels(uint32_t inColor, uint8_t inFactor)
    {
        uint8_t red = (inColor >> 16) & 0xFF;
        uint8_t green = (inColor >> 8) & 0xFF;
        uint8_t blue = inColor & 0xFF;
	 ...
	 */
	[[nodiscard]]
	static constexpr uint32_t ReduceColorWithBleed(uint32_t inColor, uint8_t inBleed)
	{
