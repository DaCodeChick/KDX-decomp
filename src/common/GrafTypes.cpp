...
bool SRect::GetUnion(const SRect &inRect, SRect &outUnion) const
{
    if (left >= right || top >= bottom ||
        inRect.left >= inRect.right || inRect.top >= inRect.bottom)
	{
