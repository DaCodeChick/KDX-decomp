...
void UCryptTransact::DataCrypt(void *ioData, size_t inDataSize, unsigned inInit, unsigned inMultiplier, unsigned inAddend)
{
	if (!ioData || inDataSize == 0 || inDataSize & 3) return;
